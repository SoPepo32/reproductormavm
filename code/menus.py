class version_formato:
    def __new__(cls, version):
        mavm_version = {'v.2.1.0': cls.interfaz_2_1_0,'v.2.2.0': cls.interfaz_2_2_0,
                        ...
                        'v.4.2.0': cls.interfaz_4_2_0,'v.4.3.0': cls.interfaz_4_3_0}
        if version in list(mavm_version.keys()):
            return [True, mavm_version[version]]
        else:
            return [False, None]
    ...
    class interfaz_4_3_0:
        ...
        def comando_x(self, comandos, lista_comandos, scripts_name):
                ...
                elif comando == "polygon":
                    if parametros[0] == "create":
                        lista_comandos.append(["polygon", {
                            "create": parametros[1],
                            "coordinates": parametros[2],
                            "color": parametros[4]
                        }])
                    elif parametros[0] == "edit":
                        lista_comandos.append(["polygon", {
